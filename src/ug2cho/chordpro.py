...
def ug_to_chordpro(ug: UG):
    tab_lines = untokenise_tab(intersperse_chords(tokenise_tab(ug.leadsheet)))
    header_lines = [
        chordpro_directive('title', ug.metadata.get('song_name')),
        chordpro_directive('artist', ug.metadata.get('artist_name')),
        chordpro_meta('capo', ug.metadata.get('capo')),
        chordpro_meta('key', ug.metadata.get('key')),
        chordpro_meta('tuning', ug.metadata.get('tuning')),
        chordpro_meta('version', ug.metadata.get('version')),
        chordpro_meta('difficulty', ug.metadata.get('difficulty')),
        chordpro_meta('leadsheet_orig_author', ug.metadata.get('leadsheet_author_url')),
        chordpro_meta('leadsheet_orig_url', ug.metadata.get('leadsheet_url')),
    ]
